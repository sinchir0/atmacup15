...
# unique_user_id = list(set(train_data["user_id"].tolist() + test_data["user_id"].tolist()))
# unique_anime_id = list(set(train_data["anime_id"].tolist() + test_data["anime_id"].tolist()))
